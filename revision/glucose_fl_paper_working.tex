...
Jiahao Sun\textsuperscript{4},
Pantelis Georgiou\textsuperscript{5},
Simon Harper\textsuperscript{6},
...
\\
\textbf{4} [Flock.io Ltd]
\\
\textbf{5} Centre for Bio-Inspired Technology, Imperial College London, United Kingdom
\\
\textbf{6} University of Manchester, Manchester, United Kingdom
\\
\bigskip
...
The meta-learned federated model (MLDG) beat local training on the
contributing cohorts, $20.25$ vs $20.49$ mg/dL RMSE at 30 minutes, lower on
...
training, MLDG against the centralised reference, MLDG against FedAvg on
