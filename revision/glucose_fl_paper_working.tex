...
dataset & patients & total windows & mean CGM & sd CGM & TIR (\%) \\
        &          &               & (mg/dL)  & (mg/dL) & 70--180  \\
\hline
\multicolumn{6}{l}{\emph{federated clients}} \\
...
\hline
\multicolumn{6}{l}{\emph{held-out OOD cohorts}} \\
ReplaceBG & 208 & 9,924,380 & 160.7 & 64.5 & 63.1 \\
BrisT1D   & 19 & 792,546 & 157.5 & 60.0 & 68.6 \\
Flair     & 113 & 2,799,490 & 161.6 & 60.4 & 65.7 \\
\thickhline
\end{tabular}
\begin{center}
...
targets (Table~\ref{tab:finetune}). ARISES is both the highest-glucose and the
