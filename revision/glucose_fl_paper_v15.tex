...
are publicly available through the MetaboNet consolidation
\cite{wolff2026metabonet}, as is the held-out ReplaceBG cohort
\cite{aleppo2017replacebg}; the other held-out cohorts, BrisT1D
\cite{james2025brist1d} and Flair \cite{jaeb_flair}, are publicly available from
their original repositories. ABC4D \cite{abc4d_nct} and ARISES
