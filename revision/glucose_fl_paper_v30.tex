...
Taiyu Zhu\textsuperscript{3,4,5},
Jiahao Sun\textsuperscript{6},
Pantelis Georgiou\textsuperscript{7},
Simon Harper\textsuperscript{8},
...
\\
\textbf{5} NIHR Maudsley Biomedical Research Centre, London, United Kingdom
\\
\textbf{6} [Flock.io Ltd]
\\
\textbf{7} Centre for Bio-Inspired Technology, Imperial College London, United Kingdom
\\
\textbf{8} University of Manchester, Manchester, United Kingdom
\\
\bigskip
...
$\approx 63{,}000$ patient-days), we benchmarked single-cohort local
...
model trained on the four cohorts pooled, under $1\%$ of CGM sensor error,
...
$21.30$ mg/dL without seeing any of its patients, ahead of FedAvg ($21.48$)
...
ReplaceBG, $10$ for Flair) still beat from-scratch training on the full
cohort.
