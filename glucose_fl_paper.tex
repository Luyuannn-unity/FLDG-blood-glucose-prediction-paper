...
ABC4D, ARISES, and T1D-UOM --- with \emph{one dataset per client}. Each dataset
...
\thickhline
\end{tabular}
\begin{flushleft} ReplaceBG (OOD test client) is excluded from training and
reported separately. ARISES is both the highest-glucose and the smallest cohort.
\end{flushleft}
\label{tab:datasets}
\end{adjustwidth}
\end{table}
