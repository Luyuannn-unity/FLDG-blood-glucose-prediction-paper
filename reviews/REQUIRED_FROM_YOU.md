...
| ~~6~~ | ~~Author block~~ | **CLOSED 2026-09-09.** Eight authors: Qi¹ (UCL IHI), Taylor¹, Rui Sun² (Newcastle Computing), Taiyu Zhu³ (KCL only — his confirmation 2026-09-09; Oxford and NIHR Maudsley removed), Jiahao Sun⁴ (FLock.io, London — line matches arXiv:2410.17933), Georgiou⁵ (Imperial Bio-Inspired Technology), Harper⁶ (Manchester), Kezhi Li¹* (ken.li@ucl.ac.uk). Jiahao Sun and Georgiou were added by the author on Overleaf 2026-09-03. Remaining, in the PLOS system only: corresponding-author ORCID, CRediT roles for all eight, optional Manchester department. |
...
| ~~8~~ | ~~ARISES citation author list / ABC4D registry-vs-paper~~ | **CLOSED 2026-09-03** by a web verification pass against primary sources. ARISES: Zhu, Kuang, Daniels, Herrero, Li, Georgiou (npj Digit Med 5:78, 2022) — matches the bib. ABC4D: the registry cite (NCT02053051) stays; the cohort details (Dexcom G5, 25 subjects, six months, median age 36, IQR 29–46) are documented in Zhu et al. IEEE TBME 2022 and GluGAN (IEEE JBHI 2023) — the latter now in the bib as `zhu2023glugan`, cited in the Table 1 caption for the age statistic. |
